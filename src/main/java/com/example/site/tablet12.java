...
public class tablet12 implements Initializable {
    @FXML
    public Label alart;
    public void kharid (ActionEvent event) {
        if(loginpage.mm){
            ...
            int indexPro = 49; //شماره کلمه ای که می خواهم بگیرم
            int I = 0;
    ...
    public void backpage(ActionEvent event) {
        openNewWindow("tablet.fxml","lenoShop",event);
    }
    ...
    public void tablet12ToProfile(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/site/loginpage.fxml"));
            Scene scene = new Scene(loader.load(), 1535, 790);
