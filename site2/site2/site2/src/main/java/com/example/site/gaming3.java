...
public class gaming3  implements Initializable {
    public void gaming3ToProfile(ActionEvent event) throws IOException {
        try {
    ...
    public void kharid (ActionEvent event) {
        if(loginpage.mm){
            ...
            int indexPro = 2; //شماره کلمه ای که می خواهم بگیرم
            int I = 0;
